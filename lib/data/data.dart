...
final Content sintelContent = Content(
  ...
  description:
      'Uma jovem solitária, Sintel, ajuda e torna-se amiga de um dragão\n, a quem chama de Balança. Mas quando ele é sequestrado por um dragão adulto\n, Sintel decide embarcar em uma perigosa jornada para encontrar\n seu amigo perdido, Escalas.',
);
